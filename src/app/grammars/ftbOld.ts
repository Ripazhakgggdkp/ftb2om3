...
export var ParserRules: NearleyRule[] = [
    ...
    {"name": "map$ebnf$1", "symbols": ["map$ebnf$1", "bpm"], "postprocess": (d) => d[0].concat([d[1]])},
    {"name": "map$ebnf$2", "symbols": []},
    {"name": "map$ebnf$2", "symbols": ["map$ebnf$2", "note"], "postprocess": (d) => d[0].concat([d[1]])},
    {"name": "map", "symbols": ["start", "map$ebnf$1", "map$ebnf$2"], "postprocess": function(d) { return { bpms:d[1], notes:d[2]}}},
    {"name": "start$string$1", "symbols": [{"literal":"#"}, {"literal":"#"}, {"literal":"#"}, {"literal":"F"}, {"literal":"I"}, {"literal":"L"}, {"literal":"E"}, {"literal":" "}, {"literal":"A"}, {"literal":"L"}, {"literal":"R"}, {"literal":"E"}, {"literal":"A"}, {"literal":"D"}, {"literal":"Y"}, {"literal":" "}, {"literal":"P"}, {"literal":"A"}, {"literal":"R"}, {"literal":"S"}, {"literal":"E"}, {"literal":"D"}, {"literal":"#"}, {"literal":"#"}, {"literal":"#"}], "postprocess": (d) => d.join('')},
    {"name": "start", "symbols": ["start$string$1", "_", {"literal":"\n"}]},
    {"name": "note", "symbols": ["decimal", "__", {"literal":"0"}, "__", "lane", "_"], "postprocess": function(d) { return {type: 'note', millisecond: d[0], lane: d[4]}}},
    {"name": "note", "symbols": ["decimal", {"literal":"-"}, "decimal", "__", {"literal":"0"}, "__", "lane", "_"], "postprocess": function(d) { return {type: 'hold', start: d[0], end: d[2], lane: d[6]} }},
    {"name": "bpm$string$1", "symbols": [{"literal":"B"}, {"literal":"P"}, {"literal":"M"}], "postprocess": (d) => d.join('')},
    {"name": "bpm", "symbols": ["bpm$string$1", "__", "decimal", "__", "decimal", "_"], "postprocess": function(d) { return {type: 'bpm', value: d[0], millisecond: d[4]}}},
    {"name": "lane", "symbols": [/[1-7]/], "postprocess": function(d) {return parseInt(d[0])}}
];
